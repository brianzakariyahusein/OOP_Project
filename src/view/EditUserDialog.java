...
public class EditUserDialog extends javax.swing.JDialog {
    ...
    public EditUserDialog(java.awt.Frame parent, boolean modal, int id, String username, String password, String role) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                EditUserDialog dialog = new EditUserDialog(new javax.swing.JFrame(), true, 0, "", "", "");
