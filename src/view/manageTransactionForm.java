...
public class manageTransactionForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnTransaction.setBackground(new java.awt.Color(216, 216, 216));
        ...
        jPanel19.setBackground(new java.awt.Color(216, 216, 216));
        ...
        jPanel20.setBackground(new java.awt.Color(216, 216, 216));
        ...
        btnBorrow.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        tblTransaction.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Member ID", "Book ID", "Processed By", "Borrow Date", "Return Date", "Status"
            }
        ) {
        ...
        jLabel14.setText("Transaction Data");

        jLabel15.setForeground(new java.awt.Color(102, 102, 102));
        jLabel15.setText("All Transaction Database");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(btnBorrow, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnReturn, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnBorrowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrowActionPerformed
        view.BorrowBookDialog BorrowDialog = new view.BorrowBookDialog(this, true, loggedInUserId);
    ...
    private void btnReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReturnActionPerformed
        ...
        if (baris == -1) {
            javax.swing.JOptionPane.showMessageDialog(this, "Pilih dulu data transaksi di tabel yang mau diproses!");
            return;
        }

        // Cek status saat ini di kolom ke-5 (index 4)
        String status = tblTransaction.getValueAt(baris, 4).toString();
        if (status.equals("returned")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Buku ini sudah berstatus dikembalikan coo!");
            return;
        }

        int transId = Integer.parseInt(tblTransaction.getValueAt(baris, 0).toString());
        int konfirmasi = javax.swing.JOptionPane.showConfirmDialog(this, "Proses pengembalian buku untuk transaksi ini?", "Konfirmasi", javax.swing.JOptionPane.YES_NO_OPTION);

        if (konfirmasi == javax.swing.JOptionPane.YES_OPTION) {
            dao.TransactionDAO dao = new dao.TransactionDAO();
            if (dao.returnBook(transId)) {
                javax.swing.JOptionPane.showMessageDialog(this, "Berhasil! Buku dikembalikan dan stok sudah bertambah.");
                loadData();
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "Gagal memproses pengembalian buku.");
            }
        }
