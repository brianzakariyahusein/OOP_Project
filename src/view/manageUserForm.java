...
public class manageUserForm extends javax.swing.JFrame {
     ...
     */
    public manageUserForm(int userId, String role) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel15.setText("All Staff Database");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (userId == loggedInUserId) {
            javax.swing.JOptionPane.showMessageDialog(this, "Waduh, kamu nggak boleh hapus akun kamu sendiri!");
            return;
        }
...
//        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        view.AddUserDialog addDialog = new view.AddUserDialog(this, true);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        int id = Integer.parseInt(tblUser.getValueAt(baris, 0).toString());
        String username = tblUser.getValueAt(baris, 1).toString();
        String password = tblUser.getValueAt(baris, 2).toString();
        String role = tblUser.getValueAt(baris, 3).toString();

        view.EditUserDialog editDialog = new view.EditUserDialog(this, true, id, username, password, role);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new manageUserForm(1, "admin").setVisible(true));
    }
